...
public class MainActivity extends AppCompatActivity {
    ...
    private IOnOperationCompletedListener completedListener = new IOnOperationCompletedListener.Stub() {
        ...
        public void onOperationCompleted(final Parameter result) throws RemoteException {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(MainActivity.this,"返回运算结果",Toast.LENGTH_SHORT).show();
                }
            });
        }

        @Override
        public void onOperationCompleted01(final Parameter result) throws RemoteException {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    et_result.setText("运算结果： "+result.getParam());
        ...
        @Override
        public void onOperationCompletedRegister(boolean flag){
            Toast.makeText(MainActivity.this,"retrun register result "+flag,Toast.LENGTH_SHORT).show();
        }
        @Override
        public void onOperationCompletedUnRegister(boolean flag){
            Toast.makeText(MainActivity.this,"return unregisterresult "+flag,Toast.LENGTH_SHORT).show();
        }
    };
    ...
    private void initView() {
        ...
        Button btn_operation01 = findViewById(R.id.btn_operation01);
                    ...
                    case R.id.btn_operation01:{
                        ...
                        new Thread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if(iOperationManager !=null){
                                    try {
                                        iOperationManager.operation01(parameter1,parameter2);
                                    } catch (RemoteException e) {
                                        e.printStackTrace();
                                    }
                                }
        ...
        btn_operation01.setOnClickListener(clickListener);
    }
