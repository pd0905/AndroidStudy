...
public class AIDLService extends Service {
    ...
    private IOperationManager.Stub stub = new IOperationManager.Stub() {
        ...
        @Override
        public void operation01(Parameter parameter1, Parameter parameter2){
            try {
                Thread.sleep(5000);
            } catch (InterruptedException e) {
                e.printStackTrace();
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (listener != null) {
                    try {
                        listener.onOperationCompleted01(parameter);
        ...
        public void registerListener(IOnOperationCompletedListener listener) throws RemoteException {
            ...
            if(listener!= null){
                listener.onOperationCompletedRegister(true);
            }
        ...
        public void unregisterListener(IOnOperationCompletedListener listener) throws RemoteException {
            ...
            if(listener != null){
                listener.onOperationCompletedUnRegister(true);
            }
